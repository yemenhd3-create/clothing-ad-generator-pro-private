...
| العمل المحلي بعد التحقق | نعم خلال `offlineGraceHours` | نعم عند التحقق والتجديد | لا يبدأ المسار المحمي دون بريد أو كود صالح |
| اختيار الصور بعد التحقق | نعم | لا | من الجهاز وفق صلاحيات Android المتاحة |
...
| جلسة الحساب/قاعدة البيانات | لا | نعم | تستخدم للتحقق والحضور وتجديد الصلاحية فقط |
...
## سياسة الوصول والتحكم الحالية

يفرض مسار الإنتاج المرور عبر بوابة الوصول. يدخل المستخدم بالبريد أو بكود يصدره المطور؛ لا يُستخدم Guest Mode المفتوح في مسار الإنتاج. يستطيع المطور من لوحة الويب فتح أو إيقاف التسجيل الجديد، وإنشاء الأكواد بمدة وعدد استخدامات، وإيقاف المستخدم أو إعادة تفعيله.
