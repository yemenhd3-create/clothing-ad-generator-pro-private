...
type StudioAppearancePatch = Partial<Pick<TemplateSettings, 'size' | 'productBackdrop' | 'productShadow' | 'studioCaption' | 'studioCaptionTextColor' | 'studioCaptionBackgroundColor' | 'studioCaptionPosition' | 'studioPrice' | 'studioPriceTextColor' | 'studioPriceBackgroundColor' | 'studioPricePosition'>>;
